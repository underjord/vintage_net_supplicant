defmodule VintageNetSupplicant.AccessPoint do
  @moduledoc """
  ...
  * `:ssid` - the access point's name
  """
  alias VintageNetSupplicant.Utils
  ...
  """
  @spec new(any) :: VintageNetSupplicant.AccessPoint.t()
  def new(bssid) do
    %__MODULE__{
      bssid: bssid,
      frequency: 0,
  ...
  @spec new(String.t(), String.t(), non_neg_integer(), integer(), [flag()]) ::
          VintageNetSupplicant.AccessPoint.t()
